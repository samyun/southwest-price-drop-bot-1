...
async function getFlights ({ from, to, departDate, returnDate, passengers, isPointsBooking, browser, lock }) {
  ...
  try {
    if (lock) {
      ...
      html = await getPage(from, to, departDate, returnDate, passengers, isPointsBooking, browser);
      await lock.signal();
...
function createUrl (from, to, departDate, returnDate, passengers, isPointsBooking) {
...
async function getPage (from, to, departDate, returnDate, passengers, isPointsBooking, browser) {
...
//  await page.screenshot({ path: 'testresult.png', fullPage: true })
  ...
  try {
    const url = createUrl(from, to, departDate, returnDate, passengers, isPointsBooking);
